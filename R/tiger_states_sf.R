...
#' @param sf_key The column from the resultant sf dataframe used to key with the \code{datafile} dataframe.
...
#'   then you assign \code{express} equal to: \code{expression(STATEFP == "12")}. The expression will be
