...
#'
#' For a Census Bureau categorical variable return a data.table with the
...
#'   return a data.table with both the integer values and corresponding label strings. If
...
#' @param name A string that is the name of the categorical variable of interest. This is a required parameter.
#' @param get_names An optional logical which if TRUE the function will return
...
#'
#' @return A data.table with the variable's integer values and corresponding label strings.
#'
#' @author Rick Dean
#'
#' @import data.table
